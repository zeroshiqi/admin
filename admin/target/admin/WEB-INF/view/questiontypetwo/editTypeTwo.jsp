...
<body>
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">编辑问题一级目录</strong> / <small>Edit QuestionFirstType</small></div>
    </div>
...
<%--               	<input type="text" id="q-parent-title" name="parent" placeholder="所属一级目录名称" value="${record.parent_name}"> --%>
				<label for="q-question" class="am-u-sm-3 am-form-label">所属一级目录</label>
	              ...
	              <br>
	              <form class="am-form am-form-horizontal" id="myform" method="post" >
	              	<input type="text" name="demo" id="demo" placeholder="输入名称搜索一级目录" style="float: left;width: 315px;"/>
	              </form>
