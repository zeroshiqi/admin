...
<body>
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新增问题一级目录</strong> / <small>Edit QuestionFirstType</small></div>
    </div>
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" id="myform" method="post" >
          ...
          <div class="am-form-group">
            <label for="q-question" class="am-u-sm-3 am-form-label">问题一级目录</label>
            <div class="am-u-sm-9">
...
function save(){
	...
	$('#myform').ajaxSubmit({
		type:'post',
		url:"/admin/typeone/save",
	    success:function(data){
	        if(data.status == 200){
	           	window.location.href = "/admin/typeone";
	        }else{
