						...
						<table class="am-table am-table-striped am-table-hover table-main">
							<thead>
								<tr>
									...
									<th class="table-title">A</th>
									<th class="table-title">B</th>
									<th class="table-type">C</th>
									<th class="table-type">D</th>
									<th class="table-type">正确答案</th>
									<th class="table-type">出题人</th>
