			...
			<div class="am-u-md-3 am-cf">
				<form method="post" id="xlsForm">
					...
					<div class="Go">
						...
						<input type="text" placeholder="昵称" class="text"  style="width: 120px;" id="searchName" name="name">
...
<script type="text/javascript">
	...
	function deleteA(id){
	 ...
	 function submitForm() {
			window.location.href = "/admin/company/power?mobile="+ $("#searchMobile").val()+"&name="+ $("#searchName").val();
	}
	 //使企业用户生效
