    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 maxWidth">
		...
		<div class="am-form-group">
          ...
          <div class="am-form-group" id="gongkai">
	            <label for="course-teacher" class="am-u-sm-3 am-form-label">公开课课程包：</label>
	            <div class="am-u-sm-9">
	            
		                <input style="width: 50%" type="text" id="course-type-name1" readonly="readonly" name="typeName1" value="${offline.catalog_name}">
						<input type="hidden" id="course-hidden-type1" name="typeId1" readonly="readonly" value="${offline.catalog_id}">
						<input type="text" name="typeDemo1" id="typeDemo1" placeholder="输入名称搜索课程包" style="float: left;width: 315px;"/>
						<select id="typeList1" style="float: left;width: 315px;height: 43px;"></select>
						<div style="float: right;">
							<a class="am-btn am-btn-primary" id="addType1" >选为关联公开课</a>&nbsp;<a class="am-btn am-btn-primary" id="clearType1">清除</a>
						</div>
		          </div>
		          <label for="course-newtype" class="am-u-sm-3 am-form-label">好多课会员期限：</label>
		            <div class="am-u-sm-9">
		              	<input type="text" name="expiryDate1" id="expiry-date1" value="${offline.expiry_date}" placeholder="会员期限" >
		            </div>
          </div>
          <div class="am-form-group">
...
<%-- 		        	<c:if test="${offline.newtype==0 }"> --%>
		            	<label for="q-message" class="am-u-sm-3 am-form-label">审核通过短信：</label>
<%-- 		            </c:if> --%>
...
<%-- 		          <c:if test="${offline.newtype==0 }"> --%>
		          <div class="am-form-group">
		            <label for="q-message" class="am-u-sm-3 am-form-label">审核通过邮件：</label>
		            <div class="am-u-sm-9">
		<%--               <input type="text" id="q-question" name="question" placeholder="问题" value="${record.title}"> --%>
<%-- 		              <textarea rows="6" cols="" id="q-email" name="email" placeholder="审核通过邮件" value="">${offline.email}</textarea> --%>
<!-- 		              点击按钮添加关键字： -->
<!-- 		              	<a class="am-btn am-btn-primary" id="msgQianMing" >短信签名</a> -->
<!-- 		              	<a class="am-btn am-btn-primary" id="msgName" >学员姓名</a> -->
<!-- 		            	<a class="am-btn am-btn-primary" id="msgCourseName" >课程名称</a> -->
<!-- 		            	<a class="am-btn am-btn-primary" id="msgTime" >开课时间</a> -->
<!-- 		            	<a class="am-btn am-btn-primary" id="msgMobile" >手机号</a> -->
						<script id="editor1" type="text/plain" style="width:515px;height:300px;">${offline.email}</script>
		             	<input type="hidden" name="email" id="email" />
<!-- 		             	<input type="text" id="demo" name="demo"/><a class="am-btn am-btn-primary" id="msgQianMing" >测试一下</a> -->
		            </div>
		            	
		          </div>
		          <div class="am-form-group">
		            <label for="q-message" class="am-u-sm-3 am-form-label">审核未通过短信：</label>
		            <div class="am-u-sm-9">
		<%--               <input type="text" id="q-question" name="question" placeholder="问题" value="${record.title}"> --%>
		              <textarea rows="6" cols="" id="q-message1" name="message1" placeholder="审核未通过短信" value="">${offline.message1}</textarea>
		              点击按钮添加关键字：
		              	<a class="am-btn am-btn-primary" id="msgQianMing1" >短信签名</a>
		              	<a class="am-btn am-btn-primary" id="msgName1" >学员姓名</a>
		            	<a class="am-btn am-btn-primary" id="msgCourseName1" >课程名称</a>
		            	<a class="am-btn am-btn-primary" id="msgTime1" >开课时间</a>
		            	<a class="am-btn am-btn-primary" id="msgMobile1" >手机号</a>
		            </div>
		          </div>
		          <div class="am-form-group">
		            <label for="q-message" class="am-u-sm-3 am-form-label">审核未通过邮件：</label>
		            <div class="am-u-sm-9">
		            	<script id="editor2" type="text/plain" style="width:515px;height:300px;">${offline.email1}</script>
		             	<input type="hidden" name="email1" id="email1" />
		<%--               <input type="text" id="q-question" name="question" placeholder="问题" value="${record.title}"> --%>
<%-- 		              <textarea rows="6" cols="" id="q-email1" name="email1" placeholder="审核未通过短信" value="">${offline.email1}</textarea> --%>
<!-- 		              点击按钮添加关键字： -->
<!-- 		              	<a class="am-btn am-btn-primary" id="msgQianMing" >短信签名</a> -->
<!-- 		              	<a class="am-btn am-btn-primary" id="msgName" >学员姓名</a> -->
<!-- 		            	<a class="am-btn am-btn-primary" id="msgCourseName" >课程名称</a> -->
...
<%-- 		         </c:if> --%>
		         <div class="am-form-group">
		            <label for="q-message2" class="am-u-sm-3 am-form-label">赠送短信：</label>
		            <div class="am-u-sm-9">
		<%--               <input type="text" id="q-question" name="question" placeholder="问题" value="${record.title}"> --%>
		              <textarea rows="6" cols="" id="q-message2" name="message2" placeholder="赠送短信" value="">${offline.message2}</textarea>
		              点击按钮添加关键字：
		              	<a class="am-btn am-btn-primary" id="msgQianMing2" >短信签名</a>
		              	<a class="am-btn am-btn-primary" id="msgName2" >学员姓名</a>
		            	<a class="am-btn am-btn-primary" id="msgCourseName2" >课程名称</a>
		            	<a class="am-btn am-btn-primary" id="msgTime2" >开课时间</a>
		            	<a class="am-btn am-btn-primary" id="msgMobile2" >手机号</a>
		            </div>
		          </div>
		           <div class="am-form-group">
		            <label for="q-message2" class="am-u-sm-3 am-form-label">赠送审核通过短信：</label>
		            <div class="am-u-sm-9">
		<%--               <input type="text" id="q-question" name="question" placeholder="问题" value="${record.title}"> --%>
		              <textarea rows="6" cols="" id="q-message3" name="message3" placeholder="赠送审核成功短信" value="">${offline.message3}</textarea>
<!-- 		              点击按钮添加关键字： -->
<!-- 		              	<a class="am-btn am-btn-primary" id="msgQianMing2" >短信签名</a> -->
<!-- 		              	<a class="am-btn am-btn-primary" id="msgName2" >学员姓名</a> -->
<!-- 		            	<a class="am-btn am-btn-primary" id="msgCourseName2" >课程名称</a> -->
...
<!-- 		            	<a class="am-btn am-btn-primary" id="msgMobile2" >手机号</a> -->
		          ...
		          <div class="am-form-group">
		            <label for="q-message" class="am-u-sm-3 am-form-label">赠送审核通过邮件：</label>
		            <div class="am-u-sm-9">
						<script id="editor3" type="text/plain" style="width:515px;height:300px;">${offline.email2}</script>
		             	<input type="hidden" name="email2" id="email2" />
		            </div>
		          </div>
		           <div class="am-form-group">
		            <label for="q-message2" class="am-u-sm-3 am-form-label">赠送审核不通过短信：</label>
		            <div class="am-u-sm-9">
		<%--               <input type="text" id="q-question" name="question" placeholder="问题" value="${record.title}"> --%>
		              <textarea rows="6" cols="" id="q-message4" name="message4" placeholder="赠送审核不通过短信" value="">${offline.message4}</textarea>
<!-- 		              点击按钮添加关键字： -->
<!-- 		              	<a class="am-btn am-btn-primary" id="msgQianMing2" >短信签名</a> -->
<!-- 		              	<a class="am-btn am-btn-primary" id="msgName2" >学员姓名</a> -->
<!-- 		            	<a class="am-btn am-btn-primary" id="msgCourseName2" >课程名称</a> -->
...
<!-- 		            	<a class="am-btn am-btn-primary" id="msgMobile2" >手机号</a> -->
		          ...
		          <div class="am-form-group">
		            <label for="q-message" class="am-u-sm-3 am-form-label">赠送审核未通过邮件：</label>
		            <div class="am-u-sm-9">
						<script id="editor4" type="text/plain" style="width:515px;height:300px;">${offline.email3}</script>
		             	<input type="hidden" name="email3" id="email3" />
<!-- 		             	<input type="text" id="demo" name="demo"/><a class="am-btn am-btn-primary" id="msgQianMing" >测试一下</a> -->
		            </div>
		          </div>
		          <div class="am-form-group">
		            <label for="q-message" class="am-u-sm-3 am-form-label">结业证书邮件：</label>
		            <div class="am-u-sm-9">
						<script id="editor5" type="text/plain" style="width:515px;height:300px;">${offline.email4}</script>
...
// 		}
		...
		$("#email").val(ue1.getContent()); 
		$("#email1").val(ue2.getContent()); 
		$("#email2").val(ue3.getContent()); 
		$("#email3").val(ue4.getContent()); 
		$("#email4").val(ue5.getContent()); 
			...
			success : function(data) {
				if(data.status == 200){
					if(types == 0){
						...
						window.location.href = "/admin/course/publicClass";
					}else{
...
$(function(){
	...
	$('#course-newtype').change(function(){
	...
	$("#typeDemo1").bind("change",function(){
		$("#typeDemo1").empty();
		addType1($("#typeDemo1").val());
	});
	 //清除课程分类
    ...
    //清除课程分类
    $("#clearType1").bind("click",function(){
		$("#course-hidden-type1").val('');
		$("#course-type-name1").val('');
	});
  //选择分类课程
	...
	//选择公开课
	$("#addType1").bind("click",function(){
		var text = $("#course-type").val();
		var ids = $("#id").val();
		if($("#typeList1 option:selected").val() == ''){
			return;
		}
		$("#course-hidden-type1").val($("#typeList1 option:selected").val());
		$("#course-type-name1").val($("#typeList1 option:selected").text());
	});
	$("#imglive").premage({
		width:'200px',
	    height:'200px',
...
function addType1(str){
	$.getJSON("/admin/banner/queryCatalogGroup?name="+str,function(result){
		var html = "";
		for(var i=0;i<result.length;i++){
			html += "<option value='"+result[i].id+"'>";
			html += result[i].value;
