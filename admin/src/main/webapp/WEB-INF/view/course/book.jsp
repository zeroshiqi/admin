...
<body>
	...
	<div class="am-cf admin-main">
		...
		<div class="nav-assist">
			<ul>
				<li class="bgColor"><a href="/admin/course/bookSale">新书预售</a></li>
...
<script type="text/javascript">
	...
	function submitForm() {
		if ($("#search").val() != '') {
			...
			<c:if test="${newtype == 3}">
			window.location.href = "/admin/course/bookSale?name="
				+ $("#search").val();
			</c:if>
		}
	}
	function edit(id) {
		if (id == 0) {
			window.location.href = "/admin/course/editBook?newtype=3&type=0";
		} else {
			window.location.href = "/admin/course/editBook?newtype=3&id="+id;
		}
	}
