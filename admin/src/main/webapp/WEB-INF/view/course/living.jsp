	...
	<div class="am-cf admin-main">
		...
		<div class="nav-assist">
			<ul>
				...
				<li <c:if test="${newtype == 2}">class="bgColor"</c:if>><a href="/admin/course/living">直播课程管理</a></li>
...
<script type="text/javascript">
	...
	function submitForm() {
		if ($("#search").val() != '') {
			...
			<c:if test="${newtype == 2}">
			window.location.href = "/admin/course/living?name="
				+ $("#search").val();
			</c:if>
		}
	}
	function edit(id) {
		if (id == 0) {
			window.location.href = "/admin/course/editLivingCourse?newtype=2&type=0";
		} else {
			window.location.href = "/admin/course/editLivingCourse?newtype=2&id="+id;
		}
	}
