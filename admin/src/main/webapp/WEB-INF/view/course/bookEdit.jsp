...
<!--           </div> -->
          ...
          <div class="am-form-group">
            <label for="course-name" class="am-u-sm-3 am-form-label">书籍名称：</label>
            <div class="am-u-sm-9">
              <input type="text" name="courseName" id="course-name" value="${course.course_name}" placeholder="书籍名称"  >
            </div>
          </div>
           ...
           <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              	<select id="course-newtype" name="newtype">
              		<option value="3" selected="selected">新书预售</option>
...
<!--           </div> -->
          <div class="am-form-group">
            <label for="course-beginTime" class="am-u-sm-3 am-form-label">开售时间：</label>
            <div class="am-u-sm-9">
...
<%--               <input type="text" name="beginTime" id="course-beginTime" onFocus="WdatePicker({startDate:'%y-%M-%d 23:59:00',dateFmt:'yyyy-MM-dd HH:mm'})" value="${course.begin_time}"/> --%>
          ...
          <div class="am-form-group">
            <label for="course-beginTime" class="am-u-sm-3 am-form-label">结束时间：</label>
            <div class="am-u-sm-9">
		 ...
		 <div>
		 	<div class="am-form-group">
	            <label for="offline-type" class="am-u-sm-3 am-form-label">类型：</label>
	            <div class="am-u-sm-9">
	         ...
	         <div class="am-form-group">
	            <label for="course-price" class="am-u-sm-3 am-form-label">单价：</label>
	            <div class="am-u-sm-9">
	              <input type="text" id="course-price" name="price" value="${offline.price}" placeholder="单价">
	            </div>
	         </div>
	         
	          <div class="am-form-group">
	            <label for="course-time" class="am-u-sm-3 am-form-label">销售时间：</label>
	            <div class="am-u-sm-9">
	              <input type="text" id="course-time" name="courseTime" value="${offline.course_time}" placeholder="销售时间">
...
<!-- 		       </div> -->
		       <div class="am-form-group">
	            <label for="course-teacher" class="am-u-sm-3 am-form-label">作者：</label>
	            <div class="am-u-sm-9">
...
<!-- 		            	<label for="q-message" class="am-u-sm-3 am-form-label">购买成功短信：</label> -->
<%-- <%-- 		            </c:if> --%>
...
<!-- 		            	<a class="am-btn am-btn-primary" id="msgCourseName" >书籍名称</a> -->
<!-- 		            	<a class="am-btn am-btn-primary" id="msgTime" >开课时间</a> -->
<!-- 		            	<a class="am-btn am-btn-primary" id="msgMobile" >手机号</a> -->
<!-- 		            </div> -->
<!-- 		          </div> -->
		        <div class="am-form-group">
		            <label for="course-studentNum" class="am-u-sm-3 am-form-label">销售总量：</label>
		            <div class="am-u-sm-9">
		              <input type="number" id="course-studentNum" value="${offline.student_num}" name="studenNumber" placeholder="销售总量">
		            </div>
		        </div>
<!-- 		        <div class="am-form-group"> -->
...
<!-- 		        <div class="am-form-group"> -->
<!-- 		            <label for="course-studentNum" class="am-u-sm-3 am-form-label">站点：</label> -->
<!-- 		            <div class="am-u-sm-9"> -->
...
<!-- 		        </div> -->
		        ...
		        <div class="am-form-group">
		            <label for="editor" class="am-u-sm-3 am-form-label">书籍介绍：</label>
		            <div class="am-u-sm-9">
...
// 		}
		...
		var options ={
			...
			success : function(data) {
				if(data.status == 200){
						window.location.href = "/admin/course/bookSale";
	            }else{
