...
<body>
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-10 maxWidth">
        <form class="am-form am-form-horizontal" id="myform" method="post" >
         <div class="am-form-group">
          ...
          <div class="am-form-group">
            <label for="user-mobile" class="am-u-sm-3 am-form-label">手机号：</label>
            <div class="am-u-sm-9">
              <input type="text" name="mobile" id="user-mobile" placeholder="手机号"  <c:if test="${member != null}">value="${member.mobile}" readonly="readonly"</c:if> >
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="password" name="password" id="user-password" <c:if test="${member != null}">readonly="readonly"</c:if> placeholder="密码">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-nickName" name="nickName" placeholder="昵称" value="${member.nick_name}">
            </div>
          </div>
		 ...
		 <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-company" value="${info.company_name}" name="company" placeholder="公司">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-job" value="${info.job_name}" name="job" placeholder="职位">
            </div>
          </div>
          ...
          <div class="am-form-group">
            <label for="user-weixin" class="am-u-sm-3 am-form-label">邮箱：</label>
            <div class="am-u-sm-9">
              <input type="text" id="user-email" value="${info.email}" name="email" placeholder="邮箱">
            </div>
          </div>
          
          
         <%--  <div class="am-form-group">
            <label for="user-jobYear" class="am-u-sm-3 am-form-label">入职时间</label>
            <div class="am-u-sm-9">
              <input type="number" id="user-jobYear" name="jobYear" value="${info.job_year }" placeholder="入职时间">
            </div>
          </div> --%>
