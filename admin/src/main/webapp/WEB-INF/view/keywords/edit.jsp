      ...
      <div class="am-u-sm-12 am-u-md-8 maxWidth">
        <form class="am-form am-form-horizontal" id="myform" method="post" >
          ...
          <div class="am-form-group">
            <label for="q-question" class="am-u-sm-3 am-form-label"></label>
            <div class="am-u-sm-9">
              <input type="text" id="q-keywords" name="keywords" placeholder="关键字名称" value="${record.keywords}">
...
function save(){
	var keywords = $("#q-keywords").val();
	if(keywords == ''){
		showInfo("请输入关键字名称!",function(){},3000);
		return;
	}
	$("#saveBtn").attr("disabled","disabled");
	$('#myform').ajaxSubmit({
		type:'post',
		url:"/admin/keywords/save",
