      ...
      <div class="am-u-sm-12 am-u-md-8 maxWidth">
        <form class="am-form am-form-horizontal" id="myform" method="post" >
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="title" id="article-title" placeholder="标题"  <c:if test="${article.title != null}">value="${article.title}"</c:if> >
...
function save(){
	...
	$('#myform').ajaxSubmit({
	    ...
	    success:function(data){
	        if(data.status == 200){
	           	window.location.href = "/admin/article?type="+$("#show_type").val();
	        }else{
	        	$("#saveBtn").removeAttr('disabled');
	            showInfo(data.msg,function(){},3000);
	        }
