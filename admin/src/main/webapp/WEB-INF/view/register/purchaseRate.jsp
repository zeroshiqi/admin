	...
	<div class="am-cf admin-main">
		...
		<div class="nav-assist">
			<ul>
				...
				<li class="bgColor"><a href="/admin/register/purchaseRate">线上课程复购率报表</a></li>
			</ul>
		</div>
...
function submitForm() {
	$('#loadingBox').show();
	$.getJSON("/admin/register/rate?beginTime="+$('#beginTime').val()+"&endTime="+$('#endTime').val(),function(result){
		$('#loadingBox').hide();
...
$(function(){
	...
	var beginDate = GetDateStr(-31) +" 00:00:00";
	$('#beginTime').val(beginDate);
	$('#endTime').val(endDate);
	$.getJSON("/admin/register/rate?beginTime="+beginDate+"&endTime="+endDate,function(result){
		$('#loadingBox').hide();
		var couList = result['couList'];
		var ccList = result['ccList'];
		var zong = result['zong'];
