...
function submitForm() {
	$.getJSON("/admin/register/activeReport?beginTime="+$('#beginTime').val()+"&endTime="+$('#endTime').val(),function(result){
		var couList = result['couList'];
		var acouList = result['acouList'];
...
$(function(){
	...
	$('#endTime').val(endDate);
	$.getJSON("/admin/register/activeReport?beginTime="+beginDate+"&endTime="+endDate,function(result){
		var couList = result['couList'];
		var acouList = result['acouList'];
		var ccList = result['list'];
		$('#activeAll').val(result['listALl']);
