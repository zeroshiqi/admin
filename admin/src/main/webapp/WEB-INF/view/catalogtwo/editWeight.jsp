      ...
      <div class="am-u-sm-12 am-u-md-8">
        <form class="am-form am-form-horizontal" id="myform" method="post" >
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
            	<input type="hidden" id="q-id" name="id" value="${record.id}">
            	<input type="hidden" id="q-catalog-id" name="catalogId" value="${record.catalog_id}">
...
function save(){
	var weight = $("q-weight").val();
	if(weight == ''){
		showInfo("请输入权重值!",function(){},3000);
		return;
	}
	$("#saveBtn").attr("disabled","disabled");
	$('#myform').ajaxSubmit({
		type:'post',
		url:"/admin/catalogtwo/saveWeight",
	    success:function(data){
	        if(data.status == 200){
	           	window.location.href = "/admin/catalogtwo/queryCourse?id="+$('#q-catalog-id').val();
	        }else{
