...
<body>
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">编辑线上课程</strong> / <small>Edit Course</small></div>
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" id="myform" method="post" >
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" name="beginTime" id="course-beginTime" value="<fmt:formatDate value="${course.begin_time}" pattern="yyyy-MM-dd" />" placeholder="例 : 2015-07-30">
            </div>
          </div>
