		...
		<div class="admin-content">
			...
			<div class="am-cf am-padding">
				<div class="am-fl am-cf">
					<strong class="am-text-primary am-text-lg">奖学金列表</strong> / <small>Table</small>
				</div>
			</div>
			<div class="am-g">
...
<!-- 									<th class="table-type">状态</th> -->
							...
							<tbody>
								...
								<tr>
									<td>${obj.id}</td>
									<td style="width: 40%;">${obj.nick_name}</td>
									<td style="width: 50%;">${obj.score}</td>
<%-- 									<td>${obj.price}</td> --%>
<%-- 									<td>${obj.level}</td> --%>
<!-- 									<td> -->
